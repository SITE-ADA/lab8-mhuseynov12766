...
You must:
1. Clone the empty GitHub Classroom repository assigned to you. - DONE 
2. Take the existing project from the following repository: - done 

https://github.com/nsadili/wm2_spring_2026/tree/main/university-system

3. Copy/import the project into your own local repository. -done
